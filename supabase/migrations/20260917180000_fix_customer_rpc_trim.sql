...
-- Database Migration: 20260917180000_fix_customer_rpc_trim.sql
-- Description: Replace pg_catalog.trim with pg_catalog.btrim in create_customer_with_scheme.
-- =============================================================================
...
BEGIN
    ...
    INSERT INTO public.customers (
        ...
        v_clean_phone,
        pg_catalog.btrim(p_full_name),
        pg_catalog.nullif(pg_catalog.btrim(p_address), ''),
        pg_catalog.coalesce(pg_catalog.nullif(pg_catalog.btrim(p_city), ''), 'Dindigul'),
        pg_catalog.nullif(pg_catalog.btrim(p_pincode), ''),
        v_clean_alt_phone,
        pg_catalog.nullif(pg_catalog.btrim(p_nominee_name), ''),
        pg_catalog.nullif(pg_catalog.btrim(p_nominee_relationship), ''),

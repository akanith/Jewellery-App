...
export default async function TestAuthVerifyPage() {
  ...
  return (
    <main style={{ padding: 40, fontFamily: 'monospace', background: '#0f172a', color: '#f8fafc', minHeight: '100vh' }}>
      <h1 style={{ color: '#fbbf24' }}>E2E SUPABASE AUTH LINKING VERIFICATION RESULTS</h1>
      <pre style={{ background: '#1e293b', padding: 20, borderRadius: 12, overflow: 'auto', border: '1px solid #334155' }}>
